package com.prokarma.engineering.excellence.customer.publisher.configuration;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.prokarma.engineering.excellence.customer.publisher.controller"))
